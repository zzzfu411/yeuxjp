...
const VOCAB_ID_RANGES = [
  ...
  { level: "survival", prefix: "sur-p-", from: 1, to: 31 },
  ...
  { level: "survival", prefix: "sur-t-", from: 1, to: 38 },
  ...
  { level: "survival", prefix: "sur-dem-", from: 1, to: 12 },
  { level: "survival", prefix: "sur-q-", from: 1, to: 8 },
  { level: "survival", prefix: "sur-cnt-", from: 1, to: 10 },
  { level: "daily", prefix: "day-v-", from: 1, to: 65 },
  ...
  { level: "daily", prefix: "day-gw-", from: 1, to: 50 },
  { level: "daily", prefix: "day-city-", from: 1, to: 20 },
  { level: "daily", prefix: "day-t-", from: 1, to: 15 },
  { level: "daily", prefix: "day-tr-", from: 1, to: 15 },
  { level: "daily", prefix: "day-conn-", from: 1, to: 20 },
  { level: "daily", prefix: "day-kei-", from: 1, to: 12 },
  ...
  { level: "fluent", prefix: "flu-conn-", from: 1, to: 15 },
  { level: "fluent", prefix: "flu-news-", from: 1, to: 15 },
