...
export const VOCABULARY_LEVEL_METADATA = [
  { id: "survival", label: "生存级 (N5)", desc: "购物、问路、自我介绍", count: 505, idPrefix: "sur-" },
  { id: "daily", label: "日常级 (N4-N3)", desc: "生活交流、动漫理解", count: 240, idPrefix: "day-" },
  { id: "fluent", label: "流利级 (N2-N1)", desc: "商务、新闻、深层文化", count: 195, idPrefix: "flu-" },
