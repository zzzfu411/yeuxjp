...
export const STARTER_LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "listen-te", type: "multipleChoice", title: "听音辨字", prompt: "听发音，选择对应假名。", audioText: "て", options: ["て", "と", "た", "ち"], answer: "て", itemId: "hiragana:te", itemType: "kana", mode: "listening" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "recognize-ne", type: "multipleChoice", title: "看假名选读音", prompt: "ね 的读音是？", options: ["ne", "nu", "no", "ni"], answer: "ne", itemId: "hiragana:ne", itemType: "kana", mode: "recognition" },
      { id: "listen-no", type: "multipleChoice", title: "听音辨字", prompt: "听发音，选择对应假名。", audioText: "の", options: ["の", "ぬ", "な", "ね"], answer: "の", itemId: "hiragana:no", itemType: "kana", mode: "listening" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "recognize-fu", type: "multipleChoice", title: "看假名选读音", prompt: "ふ 的读音是？", options: ["fu", "hi", "he", "ho"], answer: "fu", itemId: "hiragana:fu", itemType: "kana", mode: "recognition" },
      { id: "listen-hi", type: "multipleChoice", title: "听音辨字", prompt: "听发音，选择对应假名。", audioText: "ひ", options: ["ひ", "へ", "ほ", "ふ"], answer: "ひ", itemId: "hiragana:hi", itemType: "kana", mode: "listening" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "recognize-mu", type: "multipleChoice", title: "看假名选读音", prompt: "む 的读音是？", options: ["mu", "mi", "mo", "me"], answer: "mu", itemId: "hiragana:mu", itemType: "kana", mode: "recognition" },
      { id: "recognize-me", type: "multipleChoice", title: "形近辨认", prompt: "め 的读音是？", options: ["me", "nu", "mo", "mi"], answer: "me", itemId: "hiragana:me", itemType: "kana", mode: "recognition" },
      { id: "listen-yo", type: "multipleChoice", title: "听音辨字", prompt: "听发音，选择对应假名。", audioText: "よ", options: ["よ", "ゆ", "も", "み"], answer: "よ", itemId: "hiragana:yo", itemType: "kana", mode: "listening" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "listen-wa", type: "multipleChoice", title: "听音辨字", prompt: "听发音，选择对应假名。", audioText: "わ", options: ["わ", "れ", "ろ", "る"], answer: "わ", itemId: "hiragana:wa", itemType: "kana", mode: "listening" },
      { id: "recognize-n", type: "multipleChoice", title: "特殊的一拍", prompt: "ん 的读音是？", options: ["n", "nu", "no", "na"], answer: "n", itemId: "hiragana:n", itemType: "kana", mode: "recognition" },
      { id: "dictation-re", type: "dictation", title: "听写一个音", prompt: "听发音，输入对应平假名。", audioText: "れ", answer: "れ", itemId: "hiragana:re", itemType: "kana", mode: "listening" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "review-so", type: "multipleChoice", title: "复习：さ行", prompt: "そ 的读音是？", options: ["so", "se", "sa", "su"], answer: "so", itemId: "hiragana:so", itemType: "kana", mode: "recognition" },
      { id: "review-nu", type: "dictation", title: "复习：听写", prompt: "听发音，输入对应平假名。", audioText: "ぬ", answer: "ぬ", itemId: "hiragana:nu", itemType: "kana", mode: "listening" },
      { id: "review-ho", type: "multipleChoice", title: "复习：は行", prompt: "ほ 的读音是？", options: ["ho", "ha", "he", "hi"], answer: "ho", itemId: "hiragana:ho", itemType: "kana", mode: "recognition" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "recognize-ji", type: "multipleChoice", title: "看假名选读音", prompt: "じ 的读音是？", options: ["ji", "shi", "chi", "zu"], answer: "ji", itemId: "hiragana:ji", itemType: "kana", mode: "recognition" },
      { id: "listen-za", type: "multipleChoice", title: "清浊对比", prompt: "听发音，选择对应假名。", audioText: "ざ", options: ["ざ", "さ", "だ", "た"], answer: "ざ", itemId: "hiragana:za", itemType: "kana", mode: "listening" },
      { id: "dictation-de", type: "dictation", title: "听写一个音", prompt: "听发音，输入对应平假名。", audioText: "で", answer: "で", itemId: "hiragana:de", itemType: "kana", mode: "listening" },
      { id: "recognize-do", type: "multipleChoice", title: "再认一个", prompt: "ど 的读音是？", options: ["do", "to", "da", "de"], answer: "do", itemId: "hiragana:do", itemType: "kana", mode: "recognition" },
  ...
  },
  {
    ...
    newItemIds: [
      ...
      { type: "kana", id: "hiragana:di" },
      { type: "kana", id: "hiragana:du" },
    ],
    steps: [
      ...
      { id: "recognize-bu", type: "multipleChoice", title: "看假名选读音", prompt: "ぶ 的读音是？", options: ["bu", "fu", "pu", "bo"], answer: "bu", itemId: "hiragana:bu", itemType: "kana", mode: "recognition" },
      { id: "listen-ba", type: "multipleChoice", title: "三向辨音", prompt: "听发音，选择对应假名。", audioText: "ば", options: ["ば", "ぱ", "は", "だ"], answer: "ば", itemId: "hiragana:ba", itemType: "kana", mode: "listening" },
      { id: "recognize-di", type: "multipleChoice", title: "特例确认", prompt: "ぢ 在现代日语里的读音和哪个假名相同？", options: ["じ", "ず", "ち", "し"], answer: "じ", itemId: "hiragana:di", itemType: "kana", mode: "recognition" },
      { id: "dictation-bo", type: "dictation", title: "听写一个音", prompt: "听发音，输入对应平假名。", audioText: "ぼ", answer: "ぼ", itemId: "hiragana:bo", itemType: "kana", mode: "listening" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "recognize-kyo", type: "multipleChoice", title: "一拍还是两拍", prompt: "きょ 的读音是？", options: ["kyo", "kiyo", "ko", "kyu"], answer: "kyo", itemId: "hiragana:kyo", itemType: "kana", mode: "recognition" },
      { id: "listen-sha", type: "multipleChoice", title: "听音辨字", prompt: "听发音，选择对应假名。", audioText: "しゃ", options: ["しゃ", "さ", "しゅ", "し"], answer: "しゃ", itemId: "hiragana:sha", itemType: "kana", mode: "listening" },
      ...
      { id: "dictation-sho", type: "dictation", title: "听写拗音", prompt: "听发音，输入对应平假名（两个字）。", audioText: "しょ", answer: "しょ", itemId: "hiragana:sho", itemType: "kana", mode: "listening" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "recognize-cha", type: "multipleChoice", title: "看假名选读音", prompt: "ちゃ 的读音是？", options: ["cha", "chiya", "ja", "cho"], answer: "cha", itemId: "hiragana:cha", itemType: "kana", mode: "recognition" },
      { id: "listen-ju", type: "multipleChoice", title: "听音辨字", prompt: "听发音，选择对应假名。", audioText: "じゅ", options: ["じゅ", "じょ", "ちゅ", "じ"], answer: "じゅ", itemId: "hiragana:ju", itemType: "kana", mode: "listening" },
      ...
      { id: "recognize-jo", type: "multipleChoice", title: "再认一个", prompt: "じょ 的读音是？", options: ["jo", "ja", "cho", "yo"], answer: "jo", itemId: "hiragana:jo", itemType: "kana", mode: "recognition" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "katakana-ka", type: "multipleChoice", title: "片假名认读", prompt: "カ 的读音是？", options: ["ka", "ki", "ku", "ke"], answer: "ka", itemId: "katakana:ka", itemType: "kana", mode: "recognition" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "katakana-to", type: "multipleChoice", title: "片假名认读", prompt: "ト 的读音是？", options: ["to", "ta", "te", "ho"], answer: "to", itemId: "katakana:to", itemType: "kana", mode: "recognition" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "katakana-ma", type: "multipleChoice", title: "片假名认读", prompt: "マ 对应的平假名是？", options: ["ま", "も", "む", "ぬ"], answer: "ま", itemId: "katakana:ma", itemType: "kana", mode: "recognition" },
      { id: "katakana-n", type: "multipleChoice", title: "形近辨认", prompt: "ン 对应的平假名是？", options: ["ん", "そ", "つ", "し"], answer: "ん", itemId: "katakana:n", itemType: "kana", mode: "recognition" },
