...
function semanticsItemHref(index: number) {
  return `/semantics?item=${encodeURIComponent(semanticsData[index].id)}`
}

export default async function SemanticsPage({ searchParams }: SemanticsPageProps) {
