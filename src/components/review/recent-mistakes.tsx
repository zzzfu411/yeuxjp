...
export function RecentMistakes({ mistakes, onRemove }: RecentMistakesProps) {
  return (
    <div className="rounded-2xl border bg-muted/10 p-6 space-y-4" data-testid="recent-mistakes">
      ...
      <div className="space-y-2">
        {mistakes.slice(0, 6).map((mistake) => (
          <div key={mistake.id} className="flex items-start justify-between gap-3 rounded-xl border bg-background/60 p-4" data-testid={`recent-mistake-${mistake.id}`}>
