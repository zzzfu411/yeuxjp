...
test("browser E2E verifies non-default vocabulary levels load dynamically", () => {
  ...
  assert.match(e2e, /learnedToggle\.focus\(\)/)
  assert.match(e2e, /document\.activeElement\?\.getAttribute\("data-testid"\) === "vocabulary-learned-toggle"/)
  assert.match(e2e, /page\.keyboard\.press\("Space"\)/)
