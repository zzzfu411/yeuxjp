...
test("solid kana counts skipped foundation lessons toward N5 progress", () => {
  const empty = new Set()
  ...
  assert.equal(phases.countPhaseProgress(lessons.STARTER_LESSONS, empty, "starter-45", "solid").done, 21)
