...
test("GitHub Actions workflow automatically runs strict PWA gates for PWA-impacting changes", () => {
  ...
  assert.match(workflow, /src\/app\/\(layout\\\.tsx\|page\\\.tsx\|learn\/\|kana\/\|vocabulary\/\|quiz\/\|review\/\|semantics\/\|pragmatics\/\)/)
  assert.match(workflow, /src\/components\/\(home\|lesson\|kana\|vocabulary\|quiz\|review\|reference\)\//)
