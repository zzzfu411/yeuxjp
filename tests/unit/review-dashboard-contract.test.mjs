...
test("review page delegates dashboard surfaces while keeping SRS/session wiring", () => {
  ...
  assert.match(page, /enrollMissingReviewItems\(dashboard\.kanaEnrollMissing, kanaSrs\.enroll\)/)
  assert.match(page, /enrollMissingReviewItems\(dashboard\.vocabEnrollMissing, vocabSrs\.enroll\)/)
